...
import './CatSong.css'
const cuteMeow = require("./assets/cute-meow.wav");
const cuteMeowHigher = require("./assets/cute-meow-higherpitched.wav");
const cuteMeowLower = require("./assets/cute-meow-lowerpitched.wav");
...
export default function CatSong({ setEndOfCurrJoke }: {
    ...
    const pikaAudioHappyRef = useRef<HTMLAudioElement>(null);
    const pikaAudioSadRef = useRef<HTMLAudioElement>(null);
